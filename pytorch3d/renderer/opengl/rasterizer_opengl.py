...
class _OpenGLMachinery:
    ...
    def __init__(
        ...
        self.viewport_height, self.viewport_width = image_size
        self.program = None
    ...
    def _prepare_persistent_opengl_objects(self, program):
        """
        ...
        MAX_EGL_WIDTH = self.viewport_width
        MAX_EGL_HEIGHT = self.viewport_height
